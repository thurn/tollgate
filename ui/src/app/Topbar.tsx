  ...
  return <header className="topbar" data-tauri-drag-region>
    <div className="topbar__title" data-tauri-drag-region>
      {repository ? <>
        ...
        <button className="topbar__branch" disabled title="Only master is supported"><GitCommitHorizontal size={14} /><span>master</span><code>{shortId(repository.state.master_oid.bytes, 7)}</code><ChevronDown size={12} /></button>
